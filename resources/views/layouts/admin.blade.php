    ...
    <div class="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header d-flex align-items-center">
                <img src="{{ asset('assets/img/desacibeureum.png') }}" width="50" height="50" alt="no img">
                <h3 class="mt-2">ANKAT</h3>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <a class="btn btn-white btn-sm">{{ Auth::guard('admin')->user()->nama_petugas }}</a>
                            <a href="{{ route('admin.logout') }}" class="btn btn-logout btn-sm">Logout</a>
                        </ul>
                    </div>
                </div>
            </nav>
